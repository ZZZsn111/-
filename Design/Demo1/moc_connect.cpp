...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Connect_t, stringdata) + ofs \
...
const QMetaObject Connect::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Connect.data,
...
void *Connect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Connect.stringdata))
